...
[![x-cmd/install — delta Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/delta.svg?lang=zh)](https://x-cmd.com/install/delta)
...
合计: **68,391** 行代码（覆盖前 5 种语言、共 **105** 个文件）。
...
- **上游仓库**: <https://github.com/dandavison/delta>
...
- **Star**: 32,332 · **Fork**: 581 · **开放 issue**: 938 · **贡献者**: 154

## 累计统计

- **发布数**: 62 · **已合并 PR**: 619 · **开放 PR**: 139 · **已关闭 issue**: 625 · **开放 issue**: 313 · **提交数**: 2181

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 2 | 17 | 1 | 7 | 2 |
| last60d | 2026-07-27 | 0 | 2 | 28 | 1 | 9 | 2 |
| 90d | 2026-06-27 | 0 | 4 | 42 | 2 | 17 | 4 |
| last180d | 2026-03-29 | 0 | 4 | 62 | 5 | 29 | 5 |
| 360d | 2025-09-30 | 3 | 16 | 82 | 20 | 47 | 27 |
| last720d | 2024-10-05 | 3 | 45 | 108 | 51 | 91 | 67 |
...
delta 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `delta` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/delta.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T04:50:47Z._
